module.exports = function (canvas) {
    ...
    app.bind("path", function (render, conf) {
        var path = app.createPath(render, conf);
    ...
    app.bind("animate", function (state) {
        if (typeof(state) === "undefined") {
            app.render();
            resource.animationStatus    = requestAnimationFrame(function () {
                app.animate();
            });
        } else if (state === false) {
            var er;
            try {
                cancelAnimationFrame(resource.animationStatus);
            } catch (er) {
                console.error(er);
            }
        }
